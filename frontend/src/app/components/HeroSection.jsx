...
/**
 * Government Polytechnic, Muzaffarpur (GPM) — Homepage
 * Single-file React + Tailwind. Traditional Indian government portal aesthetic.
 * Palette: deep indigo #0b1f5e, white, saffron #FF9933, green #138808
 */

/* ---------- Tiny inline SVG icons (stroke 1.8, currentColor) ---------- */
const Icon = {
  Phone: (p) => (
  ...
  Bot: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <rect x="3" y="8" width="18" height="12" rx="2" /><circle cx="8" cy="14" r="1.5" fill="currentColor" stroke="none" /><circle cx="16" cy="14" r="1.5" fill="currentColor" stroke="none" /><path d="M12 8V4M12 4h-1M12 4h1" />
    </svg>
  ),
  Chevron: (p) => (
  ...
  Menu: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" {...p}><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="18" x2="21" y2="18" /></svg>
  ),
  Close: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" {...p}><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
  ),
  Calendar: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="3" y1="10" x2="21" y2="10" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="16" y1="2" x2="16" y2="6" /></svg>
  ),
  FileText: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg>
  ),
  BookOpen: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg>
  ),
  Award: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><circle cx="12" cy="8" r="6" /><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11" /></svg>
  ),
  Users: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
  ),
  Briefcase: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></svg>
  ),
  Building: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M3 21h18M5 21V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v16M19 21V9a2 2 0 0 0-2-2M9 7h2M9 11h2M9 15h2" /></svg>
  ),
  GradCap: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M22 10 12 5 2 10l10 5 10-5Z" /><path d="M6 12v5c0 1 2 3 6 3s6-2 6-3v-5" /></svg>
  ),
  Image: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-3.5-3.5L9 20" /></svg>
  ),
  Megaphone: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="m3 11 18-5v12L3 14v-3z" /><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" /></svg>
  ),
  Bell: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9" /><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0" /></svg>
  ),
  CheckCircle: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
  ),
  MapPin: (p) => (
  ...
  Facebook: (p) => (<svg viewBox="0 0 24 24" fill="currentColor" {...p}><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"/></svg>),
  Twitter: (p) => (<svg viewBox="0 0 24 24" fill="currentColor" {...p}><path d="M22 5.8a8.5 8.5 0 0 1-2.36.64 4.13 4.13 0 0 0 1.81-2.27 8.21 8.21 0 0 1-2.6 1 4.1 4.1 0 0 0-7 3.74A11.64 11.64 0 0 1 3.39 4.62a4.07 4.07 0 0 0 1.27 5.49 4.1 4.1 0 0 1-1.87-.51v.05a4.1 4.1 0 0 0 3.3 4 4.1 4.1 0 0 1-1.85.07 4.11 4.11 0 0 0 3.83 2.85A8.23 8.23 0 0 1 2 18.28a11.57 11.57 0 0 0 6.29 1.84c7.55 0 11.67-6.25 11.67-11.67 0-.18 0-.36-.01-.53A8.32 8.32 0 0 0 22 5.8z"/></svg>),
  Youtube: (p) => (<svg viewBox="0 0 24 24" fill="currentColor" {...p}><path d="M23 12s0-3.2-.41-4.74a2.46 2.46 0 0 0-1.72-1.72C19.32 5.12 12 5.12 12 5.12s-7.32 0-8.85.42a2.46 2.46 0 0 0-1.72 1.72C1 8.8 1 12 1 12s0 3.2.41 4.74a2.46 2.46 0 0 0 1.72 1.72c1.53.42 8.85.42 8.85.42s7.32 0 8.85-.42a2.46 2.46 0 0 0 1.72-1.72C23 15.2 23 12 23 12zM9.75 15.02V8.98L15.5 12z"/></svg>),
  Instagram: (p) => (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...p}><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>),
};

/* ---------- Spinning Ashoka Chakra SVG ---------- */
function AshokaChakra({ size = 76 }) {
  // 24 spokes, navy #0b1f5e
...
/* ---------- Main Component ---------- */
export default function GPMHome() {
  ...
  const navLinks = ["Home", "Academics", "Placements", "Notices", "Gallery"];

  const quickLinks = [
    { icon: Icon.Login, label: "Student Login", desc: "ERP, attendance & marks" },
    { icon: Icon.BookOpen, label: "E-Resources", desc: "e-Books, NPTEL, journals" },
    { icon: Icon.Award, label: "Exam Results", desc: "Semester & backlog" },
    { icon: Icon.GradCap, label: "Admissions", desc: "Apply online 2025-26" },
    { icon: Icon.Megaphone, label: "Grievance Redressal", desc: "Submit complaint" },
    { icon: Icon.Bot, label: "GPM Buddy", desc: "AI assistant 24×7" },
  ];
  ...
  const deptCards = [
    { name: "Civil Engineering", img: "https://picsum.photos/seed/gpm-dept-civil/600/400", desc: "Surveying, structural engineering, construction technology, water resources and transportation engineering labs." },
    { name: "Computer Science & Engineering", img: "https://picsum.photos/seed/gpm-dept-cse/600/400", desc: "Programming, data structures, DBMS, computer networks, full-stack development with modern labs." },
    { name: "Electrical Engineering", img: "https://picsum.photos/seed/gpm-dept-elec/600/400", desc: "Power systems, electrical machines, control systems, switchgear & protection, embedded systems." },
    { name: "Electronics Engineering", img: "https://picsum.photos/seed/gpm-dept-ece/600/400", desc: "Analog & digital circuits, microcontrollers, VLSI, communication systems and IoT specialisation." },
    { name: "Mechanical Engineering", img: "https://picsum.photos/seed/gpm-dept-mech/600/400", desc: "Thermal engineering, machine design, manufacturing, CAD/CAM, hydraulics and robotics workshops." },
    { name: "Leather Technology", img: "https://picsum.photos/seed/gpm-dept-leather/600/400", desc: "A flagship department — leather processing, footwear design, quality control and tannery management." },
  ];
  ...
  return (
    <div className="bg-white text-[#0b1f5e] font-roboto" style={{ fontFamily: "'Roboto', system-ui, sans-serif" }}>
      {/* ===================== HERO CAROUSEL ===================== */}
      <section className="relative h-[600px] overflow-hidden sm:">
        {slides.map((s, i) => (
          <div
            key={i}
          ...
          >
            ...
            <div className="relative max-w-[1320px] mx-auto px-4 sm:px-6 h-full flex items-center">
              <div className={`max-w-2xl text-white ${i === slide ? "gpm-fadeup" : ""}`}>
                <span
                  className="inline-flex items-center gap-2 px-3 py-1 rounded-sm text-[12px] font-bold uppercase tracking-wider mb-5"
                  style={{ backgroundColor: s.tagColor, color: s.tagColor === "#138808" ? "white" : "#0b1f5e" }}
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-current"></span>
                  {s.tag}
                </span>
                <h2 className="text-[34px] sm:text-[48px] font-bold leading-[1.08] mb-4" style={{ letterSpacing: "-0.015em" }}>
                  {s.title}
                </h2>
                <p className="text-[15px] sm:text-[16px] text-white/85 leading-relaxed mb-7 max-w-xl">
                  {s.subtitle}
                </p>
                <div className="flex flex-wrap gap-3">
                  <button className="bg-[#FF9933] text-[#0b1f5e] px-6 py-3 rounded-sm text-[14px] font-semibold hover:bg-[#ff8a14] transition-colors flex items-center gap-2">
        ...
        <button
          ...
          className="hidden md:flex absolute left-5 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-white/15 hover:bg-white/30 backdrop-blur items-center justify-center text-white transition-colors"
        ...
        <button
          ...
          className="hidden md:flex absolute right-5 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-white/15 hover:bg-white/30 backdrop-blur items-center justify-center text-white transition-colors"
        ...
        <div className="absolute bottom-[110px] left-1/2 -translate-x-1/2 flex gap-2.5">
          {slides.map((_, i) => (
            <button
              key={i}
              onClick={() => setSlide(i)}
              className={`h-2 rounded-full transition-all ${i === slide ? "w-8 bg-[#FF9933]" : "w-2 bg-white/50 hover:bg-white/80"}`}
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-[#0b1f5e] border-t border-white/10 ">
          <div className="max-w-[1320px] mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-4">
            {[
              ...
              <div
                key={s.l}
                className={`py-5 text-center text-white ${i !== 0 ? "md:border-l border-white/10" : ""} ${i % 2 !== 0 ? "border-l border-white/10 md:border-l" : ""} ${i === 1 ? "border-l border-white/10" : ""} ${i === 3 ? "border-l border-white/10" : ""}`}
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 bg-white">
            {quickLinks.map((q) => (
              ...
              >
                ...
                <div className="text-[11px] text-gray-500 mt-1 leading-tight">{q.desc}</div>
              </a>
            ))}
          </div>
        </div>
      ...
      <main id="main" className="max-w-[1320px] mx-auto px-4 sm:px-6 py-10">
        <div className="grid lg:grid-cols-[1fr_360px] gap-8">
          ...
          <aside className="reveal">
              ...
              <ul>
                {notices.map((n, i) => (
                  <li key={i}>
                    <a
                      href="#"
                      className="group flex items-start gap-3 px-3 py-3 border-b border-gray-100 last:border-0 hover:bg-[#FFF4E5] hover:pl-4 transition-all duration-200"
                    >
            ...
            {/* Sidebar small card: AICTE mandate */}
        ...
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {deptCards.map((d) => (
              <article
                key={d.name}
                className="group bg-white border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5 overflow-hidden"
              >
                ...
                <div className="p-5">
                  ...
                  <a href="#" className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#0b1f5e] hover:text-[#FF9933] transition-colors">
      ...
      <section className="py-14 bg-[#f6f3ea] reveal">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid lg:grid-cols-[1.4fr_1fr] gap-6">
                ...
                <table className="w-full text-[13px]">
                  ...
                  <tbody>
                    {placementData.map((r, i) => (
                      <tr
                        key={r.year}
                        className={`border-b border-gray-100 hover:bg-[#FFF4E5] transition-colors ${i % 2 === 0 ? "bg-white" : "bg-gray-50/40"}`}
                      >
            ...
            {/* Right column: Top recruiters + highest package */}
              ...
              <div className="bg-white border border-gray-200 shadow-sm">
                ...
                <div className="p-5 grid grid-cols-3 gap-2">
                  {recruiters.map((r) => (
                    <div
                      key={r}
                      className="border border-gray-200 px-2 py-3 text-center text-[12px] font-semibold text-[#0b1f5e] hover:bg-[#0b1f5e] hover:text-white transition-colors cursor-default"
                    >
                      {r}
                    </div>
                  ))}
