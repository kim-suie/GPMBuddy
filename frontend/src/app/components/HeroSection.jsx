...
export default function HeroSection() {
  ...
  // const quickLinks = [
  //   { icon: Icon.BookOpen, label: "E-Resources", href: "https://sbtelms.bihar.gov.in/login/index.php", color: "bg-emerald-50 text-emerald-600" },
  //   { icon: Icon.Award, label: "Exam Results", href: "https://sbteonline.bihar.gov.in/", color: "bg-purple-50 text-purple-600" },
  //   { icon: Icon.GradCap, label: "Admissions", href: "https://sbte.bihar.gov.in/", color: "bg-amber-50 text-amber-600" },
  //   { icon: Icon.Bot, label: "GPM Buddy", path:"login", color: "bg-indigo-50 text-indigo-600" },
  // ];
  ...
  return (
    <div className="bg-slate-50 text-[#0b1f5e] font-jakarta" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      {/* ===================== QUICK LINKS GRID =====================
      <section className="relative z-10 -mt-10 mb-6 reveal">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {quickLinks.map((q) => (
              <button 
                ...
                className="group relative bg-white border border-slate-500 px-4 py-5 flex flex-col items-center text-center rounded-2xl shadow-md shadow-slate-200/50 hover:shadow-xl hover:shadow-indigo-100 transition-all duration-300 hover:-translate-y-1.5"
              >
                <div className={`w-14 h-14 rounded-2xl ${q.color} flex items-center justify-center mb-3 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6`}>
