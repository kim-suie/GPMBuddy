...
//       <div className={`bg-slate-900 text-white border-amber-50 border-b-[1px] transition-all duration-300 overflow-hidden ${scrolled ? "max-h-0 opacity-0" : "max-h-[100px] opacity-100"}`}>
//         <div className="max-w-[1320px] mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          
//           {/* Logo + Name */}
//           <button onClick={() => onNavigate("home")} className="flex items-center gap-3 group">
//             <div className="relative">
//               <div className="absolute inset-0 bg-emerald-500 rounded-full blur-[8px] opacity-30 group-hover:opacity-50 transition-opacity"></div>
//               <img src={image_poly} alt="GPM Logo" className="relative w-11 h-11 sm:w-12 sm:h-12 object-contain rounded-2xl" />
//             </div>
//             <div className="hidden sm:block text-left">
//               <h1 className="text-[16px] sm:text-[18px] font-extrabold leading-tight text-white" style={{ letterSpacing: "-0.02em" }}>
//                 Government Polytechnic
//               </h1>
...
//             <button
//               onClick={() => onNavigate("login")}
//               className="flex items-center gap-2 bg-white/5 border border-white/10 text-white px-4 sm:px-5 py-2.5 rounded-full text-[12px] font-semibold hover:bg-white/10 transition-all"
//             >
//               <LogIn className="w-4 h-4" strokeWidth={2.5} />
//               <span className="hidden sm:inline">Admin Login</span>
//             </button>
...
//       <nav
//         className={`sticky top-0 z-40 transition-all duration-300 border-b-[1px] border-amber-50 ${
//           scrolled 
...
//               >
//                 {link.label}
//                 <span className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-[2px] bg-emerald-500 rounded-t-full transition-all duration-300 ${link.active ? "w-8" : "w-0 group-hover:w-6"}`}></span>
//               </button>
//             ))}
...
//                 Departments 
//                 <ChevronDown size={16} className={`transition-transform duration-200 ${deptOpen ? "rotate-180" : ""}`} />
//                 <span className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-[2px] bg-emerald-500 rounded-t-full transition-all duration-300 ${isDeptPage ? "w-8" : "w-0 group-hover:w-6"}`}></span>
//               </button>
...
//                   </div>
//                   <ul className="py-3 col-span-1 max-h-[350px] overflow-y-auto custom-scroll">
//                     {departments.map((dept) => (
//                       <li key={dept.id}>
//                         <button
//                           onClick={() => onNavigate(dept.id)}
