        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-8 sm:p-12 lg:p-16">
          ...
          <div className="hidden lg:block max-w-md">
            <h2 className="font-serif text-4xl xl:text-5xl leading-tight mb-6">
              Knowledge. <span className="text-[#c5a572]">Honor.</span> Future.
            </h2>
            <p className="text-slate-300 text-base leading-relaxed">
              Welcome to the official administrative portal. Sign in to access
              academic records, manage departments, and oversee university
              operations.
            </p>
          </div>
